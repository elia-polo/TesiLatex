...
\vspace{-0.5cm}
  \centering
  \includegraphics[width=0.8\textwidth]{pictures/CESNA_mean_time.pdf}
  \caption[CESNA - Tempi di esecuzione medi]{Tempi di esecuzione medi}
...
\begin{figure}[h!]
        \centering
        \begin{subfigure}[b]{0.32\textwidth}
                \includegraphics[width=\textwidth]{pictures/LAC/H1_1500_Time_magnified.pdf}
                \caption{N = 1500, h = 1}
                \label{fig:h1_lac_time_1500}
        \end{subfigure}
        \begin{subfigure}[b]{0.32\textwidth}
                \includegraphics[width=\textwidth]{pictures/LAC/H2_1500_Time_magnified.pdf}
                \caption{N = 1500, h = 2}
                \label{fig:h2_lac_time_1500}
        \end{subfigure}
        \begin{subfigure}[b]{0.32\textwidth}
                \includegraphics[width=\textwidth]{pictures/LAC/H3_1500_Time_magnified.pdf}
                \caption{N = 1500, h = 3}
        ...
        \begin{subfigure}[b]{\textwidth}
        	\centering
    		\includegraphics[width=0.6\textwidth]{pictures/LAC/H_by_Dataset_Time_3000_magnified.pdf}
    		\caption{N = 3000}
...
\begin{minipage}{.95\textwidth}
  ...
  \begin{subfigure}{.47\linewidth}
    \includegraphics[width=\linewidth]{pictures/ORCLUS/H40_1500_inner_legend.pdf}
    \caption{l = 40}
    \label{fig:orclus_H40_1500}
  \end{subfigure}
  \begin{subfigure}{.47\linewidth}
    \centering
    \includegraphics[width=\linewidth]{pictures/ORCLUS/H50_1500_inner_legend.pdf}
    \caption{l = 50}
...
\vspace{-0.4cm}
        \centering
        \includegraphics[width=.65\textwidth]{pictures/ORCLUS/cluster_skewness.pdf}
        \caption[ORCLUS - Instabilità delle prestazioni]{Instabilità delle prestazioni, partendo dall'alto per $l\in\{10,20,30,40,50\}$}
...
\begin{figure}[ht]
        \centering
        \includegraphics[width=.65\textwidth, trim=0cm 0cm 0cm 1cm, clip=true,]{pictures/MOC/boxplot_users_by_cluster.pdf}
        \vspace{-0.2cm}
